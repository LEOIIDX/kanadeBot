...
#			return
	...
	if str(message.channel.name) == 'vent' or str(message.channel.name) == 'admin-chat':
			return
	...
	for data in bResp:
		...
		for item in data['keywords']:
			if dumbLetters == data['keywords'][0]:
				match data['type']:
					case 0:
						ran = random.randint(data['rarity'][0], (data['rarity'][1] * 4))
						...
						if ran == 1:
							...
							match baseRan:
								...
								case _:
									...
									return
					case 1:
						ran = random.randint(0, (data['rarity'][1] * 4))
#						ran = random.randint(data['rarity'][0], (data['rarity'][1]))
#						ran = math.ceil(ran / 5)
						if debugValue >= 1:
							print(ran)

...
async def on_ready():
	...
	while sentQOTD != 1:
		...
		if usedCheck == 0:
			qotdEMBED = discord.Embed(colour = discord.Colour.red(), title='Question of the Day', description = "What is the best gift you've received during Christmas?")

			qotdEMBED.set_footer(text='CHRISTMAS DAY QUESTION!!!')
